    ...
    return (
        <div className="w-full">
           {isLoading ? <p>Loading...</p> : <form className="w-full" onSubmit={handleSubmit}>
                ...
                <label htmlFor="document" className="bg-secondary w-full flex h-20
                rounded-md border-4 border-dashed border-blue-900 relative">
                ...
                <input type="file" id="document"
                 ...
                 type="submit">Generate Quizz</Button>
            </form>}
        </div>
    )
}
